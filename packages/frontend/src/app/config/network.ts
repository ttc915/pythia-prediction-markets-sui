...
// ProtocolConfig shared object IDs (obtained after deployment)
export const LOCALNET_PROTOCOL_CONFIG_ID =
  process.env.NEXT_PUBLIC_LOCALNET_PROTOCOL_CONFIG_ID ||
  CONTRACT_PACKAGE_ID_NOT_DEFINED
export const DEVNET_PROTOCOL_CONFIG_ID =
  process.env.NEXT_PUBLIC_DEVNET_PROTOCOL_CONFIG_ID ||
  CONTRACT_PACKAGE_ID_NOT_DEFINED
export const TESTNET_PROTOCOL_CONFIG_ID =
  process.env.NEXT_PUBLIC_TESTNET_PROTOCOL_CONFIG_ID ||
  CONTRACT_PACKAGE_ID_NOT_DEFINED
export const MAINNET_PROTOCOL_CONFIG_ID =
  process.env.NEXT_PUBLIC_MAINNET_PROTOCOL_CONFIG_ID ||
  CONTRACT_PACKAGE_ID_NOT_DEFINED
