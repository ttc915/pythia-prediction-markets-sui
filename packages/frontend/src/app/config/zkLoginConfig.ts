...
export const ZKLOGIN_CONFIG = {
    ...
    PROVER_URL: process.env.NEXT_PUBLIC_MYSTEN_PROVER_URL || 'https://prover-dev.mystenlabs.com/v1',
    SALT_SERVICE_URL: process.env.NEXT_PUBLIC_MYSTEN_SALT_SERVICE_URL || 'https://salt.api.mystenlabs.com/get_salt',

    // OAuth configuration
    GOOGLE_CLIENT_ID: process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || '',
    REDIRECT_URL: process.env.NEXT_PUBLIC_REDIRECT_URL || 'http://localhost:3000/auth/callback',
