...
const MarketCard = ({ market, onBetYes, onBetNo }: MarketCardProps) => {
    ...
    const noPercentage = totalPool > 0 ? (market.totalNoAmount / totalPool) * 100 : 50
    ...
    return (
        <Card
            className="group relative overflow-hidden rounded-xl border-2 border-slate-200 bg-white p-0 transition-all hover:border-blue-500 hover:shadow-xl dark:border-slate-700 dark:bg-slate-800 dark:hover:border-blue-400"
        >
            <Flex direction="column" gap="4" className="p-5">
                ...
                <div className="space-y-2">
                    <Flex justify="between" align="center">
                        ...
                        <Text size="3" weight="bold" className="text-green-600 dark:text-green-400">
                    ...
                    <Flex justify="between" align="center">
                        ...
                        <Text size="3" weight="bold" className="text-red-600 dark:text-red-400">
                ...
                {/* Total Pool */}
                <Flex justify="between" align="center" className="pt-2 border-t border-slate-200 dark:border-slate-700">
                ...
                {!market.resolved && timeRemaining <= 0 && (
                    <Badge color="gray" variant="soft" size="2" className="mt-2">
                        Betting Closed
                    </Badge>
                )}
            </Flex>
