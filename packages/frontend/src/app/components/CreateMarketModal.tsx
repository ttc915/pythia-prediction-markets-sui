            ...
            <Dialog.Content maxWidth="600px">
                ...
                {success ? (
                    <Flex direction="column" gap="4" align="center" className="py-8">
                        ...
                        <Text size="5" weight="bold" className="text-green-600 dark:text-green-400">
                    ...
                    <form onSubmit={handleSubmit}>
                        <Flex direction="column" gap="4">
                            ...
                            {/* Betting End Time */}
                            <div>
                                <label htmlFor="bettingEnd" className="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-300">
                            ...
                            {/* Resolution Deadline */}
                            <div>
                                <label htmlFor="resolution" className="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-300">
                            ...
                            {/* Arbiters */}
                            <div>
                                <label htmlFor="arbiters" className="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-300">
                            ...
                            {/* Arbiter Threshold */}
                            <div>
                                <label htmlFor="threshold" className="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-300">
