...
export function AutoProfileCreator() {
    const { needsProfile, createProfile, isCreating, error, dismissProfileCreation } = useAutoCreateProfile()
        ...
        <Dialog.Root open={true}>
            <Dialog.Content style={{ maxWidth: 450 }}>
                <Flex justify="between" align="center" mb="4">
                    ...
                    <IconButton variant="ghost" color="gray" onClick={dismissProfileCreation}>
                        <X size={20} />
                    </IconButton>
                </Flex>

                <Dialog.Description size="2" mb="4">
                    To start betting on prediction markets, you need to initialize your account on the blockchain. This is a one-time setup.
                </Dialog.Description>
