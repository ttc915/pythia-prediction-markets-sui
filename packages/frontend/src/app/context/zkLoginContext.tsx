...
export function ZKLoginProvider({ children }: ZKLoginProviderProps) {
    ...
    const login = useCallback(async () => {
        try {
            ...
            const { url, nonce: generatedNonce, randomness: generatedRandomness, maxEpoch: generatedMaxEpoch } =
    ...
    const signAndExecuteTransaction = useCallback(
        async (transactionBlock: Transaction) => {
            if (!account || !ephemeralKeyPair || !zkProof || !userSalt || !jwt || maxEpoch === null) {
