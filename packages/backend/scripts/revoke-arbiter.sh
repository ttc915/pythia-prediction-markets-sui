...
# Pythia Arbiter Revocation Script
# Usage: ./revoke-arbiter.sh <ARBITER_ADDRESS>
...
echo "Revoking arbiter: $ARBITER_ADDRESS"
...
sui client call \
    --package "$PACKAGE_ID" \
    --module pythia \
    --function revoke_arbiter_entry \
    --args "$CONFIG_ID" "$ARBITER_ADDRESS" \
    --gas-budget "$GAS_BUDGET"

echo ""
echo "Arbiter revocation transaction completed successfully!"
